...
def main(in_gff, merge_report, out_merge_report, out_gff, uuid_on, prefix, digitlen, report):
...
if __name__ == '__main__':
    ...
    main(in_gff=args.gff, merge_report=args.merge_report, out_merge_report=args.out_merge_report, out_gff=args.output_gff, uuid_on=args.universally_unique_identifier, prefix=args.idprefix, digitlen=args.digitlen, report=args.report)
